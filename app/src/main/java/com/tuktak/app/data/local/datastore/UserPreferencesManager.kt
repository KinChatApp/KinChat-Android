package com.tuktak.app.data.local.datastore
...
class UserPreferencesManager @Inject constructor(
    ...
    private val contactCacheKey = stringPreferencesKey("tuktak_contact_cache")
    private val avatarCacheKey = stringPreferencesKey("tuktak_my_avatar")
